        ...
        for (var row : list) {
            for (var item : row) {
                if(item.color.equals("red")){
                    System.out.print(vilina.algo04.Color.RED + item.str + " " + vilina.algo04.Color.RESET);
                }
                else if(item.color.equals("black")){
                    System.out.print(vilina.algo04.Color.BLACK + item.str + " " + vilina.algo04.Color.RESET);
                }else
