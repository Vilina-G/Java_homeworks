package vilina.oop3;
import vilina.oop3.Comporator.HumanComporatorByAge;
import vilina.oop3.model.FamilyFree;
import vilina.oop3.model.Human;
import vilina.oop3.model.IO;
...
public class Main
{
    public static void main(String[] args)
    {
        ...
        FamilyFree.getFamilyFree().sort((Comparator<? super Human>) new HumanComporatorByAge());
